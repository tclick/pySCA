...
if __name__ == '__main__':
    ...
    print_("WARNING:  This script assumes that the headers of the two input fasta files are in IDENTICAL order."
           "If this is NOT true, the script will give incorrect results")
